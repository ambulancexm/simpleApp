...
class MxCellResourceIT {
    ...
    public static MxCell createEntity(EntityManager em) {
        MxCell mxCell = new MxCell().lg(DEFAULT_LG).style(DEFAULT_STYLE);
        return mxCell;
    }
    ...
    public static MxCell createUpdatedEntity(EntityManager em) {
        MxCell mxCell = new MxCell().lg(UPDATED_LG).style(UPDATED_STYLE);
        return mxCell;
    }
    ...
    void putNewMxCell() throws Exception {
        ...
        updatedMxCell.lg(UPDATED_LG).style(UPDATED_STYLE);
    ...
    void partialUpdateMxCellWithPatch() throws Exception {
        ...
        partialUpdatedMxCell.lg(UPDATED_LG);
    ...
    void fullUpdateMxCellWithPatch() throws Exception {
        ...
        partialUpdatedMxCell.lg(UPDATED_LG).style(UPDATED_STYLE);
